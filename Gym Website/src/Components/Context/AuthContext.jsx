...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (username, password) => {
    try {
      const response = await axios.post('https://backendpanthergym.onrender.com/login', {
        email: username,
        password: password,
      });
  ...
  const logout = async() => {
    ...
    try {
      const response = await fetch('https://backendpanthergym.onrender.com/logout', {
        method: 'POST',
        headers: {
  ...
  const refreshAccessToken = async () => {
    if (refreshToken) {
      try {
        const res = await axios.post('https://backendpanthergym.onrender.com/refresh', {}, {
          headers: {
