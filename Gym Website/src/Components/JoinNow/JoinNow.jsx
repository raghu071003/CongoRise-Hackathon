...
const JoinNow = () => {
    ...
    return (
        <div className={`fixed bottom-3 right-3 z-50 ${isVisible ? 'flex' : 'hidden'} flex-col backdrop-blur-xl text-white border w-80 items-center justify-center rounded-xl p-4 fade-in`}>
